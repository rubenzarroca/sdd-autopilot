---
name: plan-architect-opus
description: Variant of plan-architect for complexity=high or critical. Uses Opus 4.7 with xhigh effort for advanced coding and complex agentic work requiring extended exploration. Invoked by orchestrator routing, not directly.
model: opus
thinking:
  type: adaptive
effort: xhigh
